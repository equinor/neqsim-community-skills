...
```bash
python -m pip install -e skills/process/neqsim-teg-dehydration-modeling
```
...
```bash
python skills/process/neqsim-teg-dehydration-modeling/examples/basic_teg_dehydration_modeling.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-teg-dehydration-modeling/tests
```
