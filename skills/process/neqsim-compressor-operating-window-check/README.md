...
```bash
python -m pip install -e skills/process/neqsim-compressor-operating-window-check
```

## Run Example

```bash
python skills/process/neqsim-compressor-operating-window-check/examples/basic_compressor_operating_window_check.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-compressor-operating-window-check/tests
```
