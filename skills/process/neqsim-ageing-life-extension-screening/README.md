...
```bash
python -m pip install -e skills/process/neqsim-ageing-life-extension-screening
```

## Run Example

```bash
python skills/process/neqsim-ageing-life-extension-screening/examples/basic_ageing_life_extension_screening.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-ageing-life-extension-screening/tests
```
