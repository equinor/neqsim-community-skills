...
```bash
python -m pip install -e skills/safety/neqsim-vacuum-collapse-screening
```

## Run Example

```bash
python skills/safety/neqsim-vacuum-collapse-screening/examples/basic_vacuum_collapse_screening.py
```

## Run Tests

```bash
python -m pytest skills/safety/neqsim-vacuum-collapse-screening/tests
```
