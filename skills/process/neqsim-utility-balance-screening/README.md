...
```bash
python -m pip install -e skills/process/neqsim-utility-balance-screening
```

## Run Example

```bash
python skills/process/neqsim-utility-balance-screening/examples/basic_utility_balance_screening.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-utility-balance-screening/tests
```
