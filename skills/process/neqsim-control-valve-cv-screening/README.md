...
```bash
python -m pip install -e skills/process/neqsim-control-valve-cv-screening
```

## Run Example

```bash
python skills/process/neqsim-control-valve-cv-screening/examples/basic_control_valve_cv_screening.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-control-valve-cv-screening/tests
```
