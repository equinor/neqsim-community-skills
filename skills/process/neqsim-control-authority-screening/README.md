...
```bash
python -m pip install -e skills/process/neqsim-control-authority-screening
```

## Run Example

```bash
python skills/process/neqsim-control-authority-screening/examples/basic_control_authority_screening.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-control-authority-screening/tests
```
