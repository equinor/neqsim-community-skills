...
```bash
python -m pip install -e skills/flow-assurance/neqsim-multiphase-flow-slug-screening
```

## Run Example

```bash
python skills/flow-assurance/neqsim-multiphase-flow-slug-screening/examples/basic_slug_screening.py
```

## Run Tests

```bash
python -m pytest skills/flow-assurance/neqsim-multiphase-flow-slug-screening/tests
```
