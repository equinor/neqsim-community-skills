...
```bash
python -m pip install -e skills/field-development/neqsim-resource-classification-screening
```

## Run Example

```bash
python skills/field-development/neqsim-resource-classification-screening/examples/basic_resource_classification_screening.py
```

## Run Tests

```bash
python -m pytest skills/field-development/neqsim-resource-classification-screening/tests
```
