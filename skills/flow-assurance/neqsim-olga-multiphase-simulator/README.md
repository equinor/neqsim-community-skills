...
```bash
python -m pip install -e skills/flow-assurance/neqsim-olga-multiphase-simulator
```
...
```bash
python skills/flow-assurance/neqsim-olga-multiphase-simulator/examples/run_olga_case.py \
...
```bash
python -m pytest skills/flow-assurance/neqsim-olga-multiphase-simulator/tests
```
