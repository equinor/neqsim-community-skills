...
```bash
python -m pip install -e skills/flow-assurance/neqsim-surf-cooldown-screening
```

## Run Example

```bash
python skills/flow-assurance/neqsim-surf-cooldown-screening/examples/basic_surf_cooldown_screening.py
```

## Run Tests

```bash
python -m pytest skills/flow-assurance/neqsim-surf-cooldown-screening/tests
```
