...
```bash
python -m pip install -e skills/safety/neqsim-flare-radiation-screening
```

## Run Example

```bash
python skills/safety/neqsim-flare-radiation-screening/examples/basic_flare_radiation_screening.py
```

## Run Tests

```bash
python -m pytest skills/safety/neqsim-flare-radiation-screening/tests
```
