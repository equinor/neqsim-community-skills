...
```bash
python -m pip install -e skills/process/neqsim-piping-flexibility-screening
```

## Run Example

```bash
python skills/process/neqsim-piping-flexibility-screening/examples/basic_piping_flexibility_screening.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-piping-flexibility-screening/tests
```
