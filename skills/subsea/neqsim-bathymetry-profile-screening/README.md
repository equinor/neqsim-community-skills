...
```bash
python -m pip install -e skills/subsea/neqsim-bathymetry-profile-screening
```

## Run Example

```bash
python skills/subsea/neqsim-bathymetry-profile-screening/examples/basic_bathymetry_profile_screening.py
```

## Run Tests

```bash
python -m pytest skills/subsea/neqsim-bathymetry-profile-screening/tests
```
