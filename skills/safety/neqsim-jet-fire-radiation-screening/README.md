...
```bash
python -m pip install -e skills/safety/neqsim-jet-fire-radiation-screening
```

## Run Example

```bash
python skills/safety/neqsim-jet-fire-radiation-screening/examples/basic_jet_fire_radiation_screening.py
```

## Run Tests

```bash
python -m pytest skills/safety/neqsim-jet-fire-radiation-screening/tests
```
