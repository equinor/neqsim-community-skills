...
```bash
python -m pip install -e skills/process/neqsim-pipe-wall-thickness-screening
```

## Run Example

```bash
python skills/process/neqsim-pipe-wall-thickness-screening/examples/basic_pipe_wall_thickness_screening.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-pipe-wall-thickness-screening/tests
```
