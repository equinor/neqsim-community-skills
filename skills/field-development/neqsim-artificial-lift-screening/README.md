...
```bash
python -m pip install -e skills/field-development/neqsim-artificial-lift-screening
```

## Run Example

```bash
python skills/field-development/neqsim-artificial-lift-screening/examples/basic_artificial_lift_screening.py
```

## Run Tests

```bash
python -m pytest skills/field-development/neqsim-artificial-lift-screening/tests
```
