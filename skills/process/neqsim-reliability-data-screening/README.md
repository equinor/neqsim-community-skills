...
```bash
python -m pip install -e skills/process/neqsim-reliability-data-screening
```

## Run Example

```bash
python skills/process/neqsim-reliability-data-screening/examples/basic_reliability_data_screening.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-reliability-data-screening/tests
```
