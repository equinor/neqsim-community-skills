...
```bash
python -m pip install -e skills/process/neqsim-fired-heater-duty-screening
```

## Run Example

```bash
python skills/process/neqsim-fired-heater-duty-screening/examples/basic_fired_heater_duty_screening.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-fired-heater-duty-screening/tests
```
