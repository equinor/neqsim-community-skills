...
```bash
python -m pip install -e skills/process/neqsim-compressor-power-screening
```

## Run Example

```bash
python skills/process/neqsim-compressor-power-screening/examples/basic_compressor_power_screening.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-compressor-power-screening/tests
```
