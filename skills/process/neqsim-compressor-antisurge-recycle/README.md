...
```bash
python -m pip install -e skills/process/neqsim-compressor-antisurge-recycle
```

## Run Example

```bash
python skills/process/neqsim-compressor-antisurge-recycle/examples/basic_compressor_antisurge_recycle.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-compressor-antisurge-recycle/tests
```
