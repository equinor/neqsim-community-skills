...
```bash
python -m pip install -e skills/process/neqsim-uncertainty-quantification
```
...
```bash
python skills/process/neqsim-uncertainty-quantification/examples/monte_carlo_npv_study.py
python skills/process/neqsim-uncertainty-quantification/examples/global_sensitivity_with_salib.py
```
...
```bash
python -m pytest skills/process/neqsim-uncertainty-quantification/tests
```
