...
```bash
python -m pip install -e skills/process/neqsim-line-velocity-check
```

## Run Example

```bash
python skills/process/neqsim-line-velocity-check/examples/basic_line_velocity_check.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-line-velocity-check/tests
```
