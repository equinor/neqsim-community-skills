...
```bash
python -m pip install -e skills/process/neqsim-gas-turbine-performance-screening
```

## Run Example

```bash
python skills/process/neqsim-gas-turbine-performance-screening/examples/basic_gas_turbine_performance_screening.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-gas-turbine-performance-screening/tests
```
