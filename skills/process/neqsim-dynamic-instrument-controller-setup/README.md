...
```bash
python -m pip install -e skills/process/neqsim-dynamic-instrument-controller-setup
```

## Run Example

```bash
python skills/process/neqsim-dynamic-instrument-controller-setup/examples/basic_controller_setup.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-dynamic-instrument-controller-setup/tests
```
