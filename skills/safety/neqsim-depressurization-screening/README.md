...
```bash
python -m pip install -e skills/safety/neqsim-depressurization-screening
```

## Run Example

```bash
python skills/safety/neqsim-depressurization-screening/examples/basic_depressurization_screening.py
```

## Run Tests

```bash
python -m pytest skills/safety/neqsim-depressurization-screening/tests
```
