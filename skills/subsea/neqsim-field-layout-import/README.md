...
```bash
python -m pip install -e skills/subsea/neqsim-field-layout-import
```

## Run Example

```bash
python skills/subsea/neqsim-field-layout-import/examples/basic_field_layout_import.py
```

## Run Tests

```bash
python -m pytest skills/subsea/neqsim-field-layout-import/tests
```
