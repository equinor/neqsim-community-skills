...
```bash
python -m pip install -e skills/safety/neqsim-psv-orifice-screening
```

## Run Example

```bash
python skills/safety/neqsim-psv-orifice-screening/examples/basic_psv_orifice_screening.py
```

## Run Tests

```bash
python -m pytest skills/safety/neqsim-psv-orifice-screening/tests
```
