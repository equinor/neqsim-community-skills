...
```bash
python -m pip install -e skills/process/heat-exchanger-fouling-assessment
```

## Run Example

```bash
python skills/process/heat-exchanger-fouling-assessment/examples/basic_fouling_assessment.py
```

## Run Tests

```bash
python -m pytest skills/process/heat-exchanger-fouling-assessment/tests
```
