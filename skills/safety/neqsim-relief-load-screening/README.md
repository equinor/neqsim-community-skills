...
```bash
python -m pip install -e skills/safety/neqsim-relief-load-screening
```

## Run Example

```bash
python skills/safety/neqsim-relief-load-screening/examples/basic_relief_load_screening.py
```

## Run Tests

```bash
python -m pytest skills/safety/neqsim-relief-load-screening/tests
```
