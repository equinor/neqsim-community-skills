...
```bash
python -m pip install -e skills/process/neqsim-dynamic-process-preparation
```

## Run Example

```bash
python skills/process/neqsim-dynamic-process-preparation/examples/basic_dynamic_preparation.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-dynamic-process-preparation/tests
```
