...
```bash
python -m pip install -e skills/process/neqsim-sand-erosion-screening
```

## Run Example

```bash
python skills/process/neqsim-sand-erosion-screening/examples/basic_sand_erosion_screening.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-sand-erosion-screening/tests
```
