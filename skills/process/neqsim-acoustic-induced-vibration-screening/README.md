...
```bash
python -m pip install -e skills/process/neqsim-acoustic-induced-vibration-screening
```

## Run Example

```bash
python skills/process/neqsim-acoustic-induced-vibration-screening/examples/basic_acoustic_induced_vibration_screening.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-acoustic-induced-vibration-screening/tests
```
