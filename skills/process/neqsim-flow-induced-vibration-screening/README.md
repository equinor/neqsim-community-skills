...
```bash
python -m pip install -e skills/process/neqsim-flow-induced-vibration-screening
```

## Run Example

```bash
python skills/process/neqsim-flow-induced-vibration-screening/examples/basic_flow_induced_vibration_screening.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-flow-induced-vibration-screening/tests
```
