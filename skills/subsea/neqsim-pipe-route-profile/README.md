...
```bash
python -m pip install -e skills/subsea/neqsim-pipe-route-profile
```

## Run Example

```bash
python skills/subsea/neqsim-pipe-route-profile/examples/basic_pipe_route_profile.py
```

## Run Tests

```bash
python -m pytest skills/subsea/neqsim-pipe-route-profile/tests
```
