...
```bash
python -m pip install -e skills/flow-assurance/neqsim-two-phase-flow-regime-screening
```

## Run Example

```bash
python skills/flow-assurance/neqsim-two-phase-flow-regime-screening/examples/basic_two_phase_flow_regime_screening.py
```

## Run Tests

```bash
python -m pytest skills/flow-assurance/neqsim-two-phase-flow-regime-screening/tests
```
