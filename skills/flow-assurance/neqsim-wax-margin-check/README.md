...
```bash
python -m pip install -e skills/flow-assurance/neqsim-wax-margin-check
```

## Run Example

```bash
python skills/flow-assurance/neqsim-wax-margin-check/examples/basic_wax_margin_check.py
```

## Run Tests

```bash
python -m pytest skills/flow-assurance/neqsim-wax-margin-check/tests
```
