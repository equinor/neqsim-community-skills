...
```bash
python -m pip install -e skills/process/neqsim-gas-scrubber-sizing-screening
```

## Run Example

```bash
python skills/process/neqsim-gas-scrubber-sizing-screening/examples/basic_gas_scrubber_sizing_screening.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-gas-scrubber-sizing-screening/tests
```
