...
```bash
python -m pip install -e skills/process/neqsim-noise-screening
```

## Run Example

```bash
python skills/process/neqsim-noise-screening/examples/basic_noise_screening.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-noise-screening/tests
```
