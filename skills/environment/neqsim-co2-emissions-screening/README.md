...
```bash
python -m pip install -e skills/environment/neqsim-co2-emissions-screening
```

## Run Example

```bash
python skills/environment/neqsim-co2-emissions-screening/examples/basic_co2_emissions_screening.py
```

## Run Tests

```bash
python -m pytest skills/environment/neqsim-co2-emissions-screening/tests
```
