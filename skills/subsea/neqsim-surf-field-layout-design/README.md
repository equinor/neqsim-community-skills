...
```bash
python -m pip install -e skills/subsea/neqsim-surf-field-layout-design
# optional: the geographic map
python -m pip install -e "skills/subsea/neqsim-surf-field-layout-design[plot]"
```

## Run Example

```bash
python skills/subsea/neqsim-surf-field-layout-design/examples/design_barents_style_layout.py
```
...
```bash
python -m pytest skills/subsea/neqsim-surf-field-layout-design/tests
```
