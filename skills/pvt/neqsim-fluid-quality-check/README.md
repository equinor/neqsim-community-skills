...
```bash
python -m pip install -e skills/pvt/neqsim-fluid-quality-check
```

## Run Example

```bash
python skills/pvt/neqsim-fluid-quality-check/examples/check_public_composition.py
```

## Run Tests

```bash
python -m pytest skills/pvt/neqsim-fluid-quality-check/tests
```
