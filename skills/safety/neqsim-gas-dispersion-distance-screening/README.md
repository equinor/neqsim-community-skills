...
```bash
python -m pip install -e skills/safety/neqsim-gas-dispersion-distance-screening
```

## Run Example

```bash
python skills/safety/neqsim-gas-dispersion-distance-screening/examples/basic_gas_dispersion_distance_screening.py
```

## Run Tests

```bash
python -m pytest skills/safety/neqsim-gas-dispersion-distance-screening/tests
```
