...
```bash
python -m pip install -e skills/pvt/neqsim-benchmark-reference-data
```
...
```bash
python skills/pvt/neqsim-benchmark-reference-data/examples/validate_against_anchor_points.py
python skills/pvt/neqsim-benchmark-reference-data/examples/validate_with_coolprop.py
```
...
```bash
python -m pytest skills/pvt/neqsim-benchmark-reference-data/tests
```
