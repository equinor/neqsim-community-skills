...
```bash
python -m pip install -e skills/process/neqsim-pump-hydraulics-screening
```

## Run Example

```bash
python skills/process/neqsim-pump-hydraulics-screening/examples/basic_pump_hydraulics_screening.py
```

## Run Tests

```bash
python -m pytest skills/process/neqsim-pump-hydraulics-screening/tests
```
